...
with col2:
    empresa = st.selectbox('Selecione a empresa', [' ', 'Sim', 'Corumbá', 'RM Cassems', 'RM Diagnóstico', 'RM Gattas', 'Sede', 'Shopping', 'Sim CG', 'BEST', 'Cassems Naviraí'])
...
if uploaded_files:
    ...
    st.download_button(
        label="📦 Baixar ZIP",
        data=zip_buffer,
        file_name="Planilhas Estoque Cerdil.zip",
